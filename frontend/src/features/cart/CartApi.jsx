...
export const generateShareableCart=async()=>{
    try {
        const res=await axiosi.post("/cart/generate-shareable-id")
        return res.data
    } catch (error) {
        throw error.response.data
    }
...
export const fetchSharedCart=async(shareableId)=>{
    try {
        const res=await axiosi.get(`/cart/shared/${shareableId}`)
        return res.data
    } catch (error) {
        throw error.response.data
    }
