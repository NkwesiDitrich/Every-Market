            ...
            <Stack>
                <Typography gutterBottom variant='h4' fontWeight={400}>Reviews</Typography>
                {
                    reviews?.length ? (
                        ...
                        <Typography variant='h6' color={'text.secondary'} fontWeight={400}>{loggedInUser?.role === 'admin' ? "There are no reviews currently" : "Be the one to post review first"}</Typography>
                    )
