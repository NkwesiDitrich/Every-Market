...
export const toggleWishlistPublic=async(isPublic)=>{
    try {
        const res=await axiosi.post("/wishlist/toggle-public",{isPublic})
        return res.data
    } catch (error) {
        throw error.response.data
    }
...
export const fetchPublicWishlist=async(userId)=>{
    try {
        const res=await axiosi.get(`/wishlist/public/${userId}`)
        return res.data
    } catch (error) {
        throw error.response.data
    }
